import random as rnd #Se importa la libreria de numeros aleatorios

n = int(input("Ingresa el número de datos aleatorios a los que quieres aplicar los valores estadísticos: ")) #Solicitar cantidad de datos y definir lista de estos
A = []

for i in range(n): #Generar n elementos en la lista A
...
if len(A) == 0:
    print("Debes pedir generar al menos 1 elemento")
else:
